  ...
  return (
    <div className="space-y-16 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white leading-tight">
                ...
                <span className="text-blue-400">{h.heroTitle2}</span>
              </h1>
            ...
            <div className="lg:col-span-5 grid grid-cols-2 gap-4">
              <div className="rounded-2xl border border-slate-800 bg-slate-800/50 backdrop-blur-sm p-6 text-center space-y-2">
                ...
                <div className="text-2xl font-black text-white">{h.statResidentsCount}</div>
                <div className="text-xs text-slate-400">{h.statResidentsLabel}</div>
              </div>
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-800/50 backdrop-blur-sm p-6 text-center space-y-2">
                ...
                <div className="text-2xl font-black text-white">{h.statKebelesCount}</div>
                <div className="text-xs text-slate-400">{h.statKebelesLabel}</div>
              </div>
              ...
              <div className="col-span-2 rounded-2xl border border-slate-800 bg-slate-800/50 backdrop-blur-sm p-6 flex items-center justify-between">
                <div>
                  <div className="text-xs text-slate-400">{h.statServiceTitle}</div>
                  <div className="text-xl font-black text-white">{h.statServiceSub}</div>
                </div>
                <Link
                  href="/services"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center gap-4 bg-amber-50 border border-amber-200 text-amber-900 px-5 py-4 rounded-2xl shadow-xs">
          <div className="flex items-center gap-2 font-bold shrink-0">
            <AlertCircle className="w-5 h-5 text-amber-600" />
            <span>{h.urgentTag}:</span>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-slate-200 pb-4">
          <div>
            <span className="text-xs font-bold text-blue-700 uppercase tracking-wider">{h.newsBadge}</span>
      ...
      <section className="bg-slate-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-xs font-bold text-blue-700 uppercase tracking-wider">{h.quickServicesBadge}</span>
            <h2 className="text-2xl sm:text-3xl font-black text-slate-900">
              {h.quickServicesTitle}
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 hover:border-blue-300 transition-colors">
              ...
              <h3 className="font-bold text-slate-900">{h.idServiceTitle}</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 hover:border-blue-300 transition-colors">
              ...
              <h3 className="font-bold text-slate-900">{h.vitalServiceTitle}</h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                {h.vitalServiceDesc}
              </p>
              <Link href="/services" className="inline-block text-xs font-bold text-blue-700 hover:underline">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 hover:border-blue-300 transition-colors">
              ...
              <h3 className="font-bold text-slate-900">{h.tradeServiceTitle}</h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                {h.tradeServiceDesc}
              </p>
              <Link href="/services" className="inline-block text-xs font-bold text-blue-700 hover:underline">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 hover:border-blue-300 transition-colors">
              ...
              <h3 className="font-bold text-slate-900">{h.constServiceTitle}</h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                {h.constServiceDesc}
              </p>
              <Link href="/services" className="inline-block text-xs font-bold text-blue-700 hover:underline">
      ...
      {/* 6. Citizen Feedback & Grievance Banner */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-blue-700 text-white p-8 sm:p-12 shadow-xl">
          <div className="relative z-10 max-w-2xl space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-white">
              ...
              <span>{t.nav.portalSubtitle}</span>
            </div>
            <h2 className="text-2xl sm:text-4xl font-black tracking-tight">
              {h.feedbackBannerTitle}
            </h2>
            <p className="text-sm sm:text-base text-blue-100">
              {h.feedbackBannerDesc}
            </p>
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              >
                <span>{h.feedbackBannerCta}</span>
                <ArrowRight className="w-4 h-4" />
              </Link>
              <a
                href="tel:994"
                className="inline-flex items-center gap-2 rounded-xl bg-blue-800/80 hover:bg-blue-800 text-white font-bold px-5 py-3.5 text-sm border border-blue-600 transition-colors"
              >
                <span>{h.feedbackBannerCall}</span>
              </a>
            </div>
          </div>
        </div>
